...
I believe it is a fun way to log your metrics. Not, just hydration we can track this way but can also track medicine, sleep or any other habit we would like to track. We can go even beyond that i believe we can set a route where we can use this system to log anything (suitable) in a fun manner.
